...
module.exports = {
    ...
    execute(message, embed, args='') {
        ...
        // overwrite any message info where author.id exists in docObject and lmm.createdTimestamp > docObject's author.id's existing createdTimestamp
